...
function changePrice() {
    ...
    if(tipo.value == 'mixta') {
        switch(cantidad.value) {
            case 'Una': precio = 30; break;
            case 'Dos': precio = 60; break;
            case 'Tres': precio = 90; break;
            case 'Cuatro': precio = 110; break;
        }
    }
    else {
        switch(cantidad.value) {
            case 'Una': precio = 20; break;
            case 'Dos': precio = 40; break;
            case 'Tres': precio = 60;  break;
            case 'Cuatro': precio = 80; break;
        }
    }
